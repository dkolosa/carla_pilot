...
class Critic(tf.keras.Model):
    def __init__(self, layer_1, layer_2, model_name='Critic'):
        ...
        # self.mobile = MobileNetV3Small(include_top=False, weights='imagenet', input_shape=(96,96,3))
        self.cnv1 = Conv2D(64, 5, activation='relu')
        self.cnv2 = Conv2D(128, 5, strides=(2,2), activation='relu')
...
class Actor(tf.keras.Model):
    def __init__(self, n_actions, action_bound, layer_1=64, layer_2=32, model_name='Actor'):
        ...
        self.cnv1 = Conv2D(64, 5, activation='relu')
        self.cnv2 = Conv2D(128, 5, strides=(2,2), activation='relu')
        self.cnv3 = Conv2D(256, 5, activation='relu')
